 ...
 */
public class ManualDataPercentConverter implements Converter<BigDecimal> {
    @Override
    ...
    public WriteCellData<?> convertToExcelData(BigDecimal value, ExcelContentProperty contentProperty,
        ...
        return new WriteCellData<>(value.stripTrailingZeros().multiply(new BigDecimal(100)).setScale(2, RoundingMode.DOWN).toPlainString() + "%");
    }
}